// To parse this data:
//
//   import { Convert, SessionCreationRequest, SessionCreationRequestResponse, UserProfileInfo, SocketConnectionInfo, UserSessionEvent, UserSessionAction, ScoresUpdateEvent, UserConnectionStatusEvent, SessionEvent, NotificationFromSessionEvent, NotificationToSessionEvent, UserScore, SessionStateInfo, DBUserProfileInfo, OmiliaError } from "./file";
//
...
//   const userSessionAction = Convert.toUserSessionAction(json);
...
export class Convert {
    ...
    public static toUserSessionAction(json: string): UserSessionAction {
        return cast(JSON.parse(json), r("UserSessionAction"));
    }

    public static userSessionActionToJson(value: UserSessionAction): string {
        return JSON.stringify(uncast(value, r("UserSessionAction")), null, 2);
    }
